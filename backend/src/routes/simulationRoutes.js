...
router.get('/historico/:usuario_id', getHistoricoSimulacoes); // Histórico de simulações (compat)
router.get('/historico', getHistoricoSimulacoes); // Histórico com filtros e paginação via query
